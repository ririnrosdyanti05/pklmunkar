...
@section('content')
    ...
    <!-- breadcrumb-area -->
    <section class="breadcrumb_area pt-60 pb-60 tp-breadcrumb_bg" data-background="front/assets/img/banner/breadcrumb-01.jpg">
       <div class="container">
             ...
             <div class="col-md-7">
                <div class="tptrack__product">
                   <div class="tptrack__thumb">
                      <img src="front/assets/img/banner/produk.jpg" alt="">
                   </div>
